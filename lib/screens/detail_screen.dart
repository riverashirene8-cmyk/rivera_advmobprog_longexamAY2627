...
class _DetailScreenState
  ...
  Future<void> _likeComment(CommentItem comment) async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('You liked this comment! User notified.'),
  ...
  Future<void> _replyToComment(CommentItem comment) async {
    ...
    final result = await showDialog<String>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          title: Text('Reply to $displayName'),
          content: TextField(
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Reply posted! User has been notified.'),
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  const SizedBox(width: 5),
                  Text('$_dislikes', style: const TextStyle(fontSize: 12)),
  ...
  Widget _commentItem(
    ...
    final isReplied = _repliedComments[comment.id] ?? false;
